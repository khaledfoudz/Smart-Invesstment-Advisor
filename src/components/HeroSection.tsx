        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in-up">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
              Invest Smarter.{" "}
              <span className="text-gradient">Grow Confidently.</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button 
                size="lg" 
                variant="outline"
                className="border-2 border-primary/30 hover:border-primary hover:bg-primary/10 text-foreground font-semibold text-lg px-8 py-6 rounded-xl transition-all duration-300"
              >
                Watch Demo
              </Button>
            </div>
          ...
          <div className="relative animate-scale-in" style={{ animationDelay: "0.3s" }}>
            ...
            {/* Floating stat cards */}
            <div className="absolute -bottom-6 -left-6 bg-card/90 backdrop-blur-md border border-primary/20 rounded-xl p-4 shadow-lg animate-fade-in" style={{ animationDelay: "0.6s" }}>
              <div className="text-2xl font-bold text-primary">+47.3%</div>
              <div className="text-sm text-muted-foreground">Portfolio Growth</div>
            </div>
            
            <div className="absolute -top-6 -right-6 bg-card/90 backdrop-blur-md border border-secondary/20 rounded-xl p-4 shadow-lg animate-fade-in" style={{ animationDelay: "0.9s" }}>
